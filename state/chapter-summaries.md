...
Ilsa Bray refuses to sign a forward schedule reading *until reviewed and thereafter* with a wage line that has no hours, and offers the physical defect instead: on the third run the west joint comes back to its mark, walks two fingers out, and comes back. Tarin refuses to let a worker's refusal become a switch, and Ilyan files the smallest request of the batch — one span, one joint, named hands, paid, ending at the seventh morning bell. Oren records the offer and the refusal in the guild's own book. Ilsa reveals that the sealed plate's cut edge is a load-book edge, that a crew kept two witnesses, and that her grandmother said *a book without a second hand is only a record.*

## Chapter 0028 — The Two Books

Four guild hands, two ward hands, one road hand, one whistle, and nine slots with no slack in them. Ilyan writes a second rule he has never said to anybody, does not file it, and does not destroy it, after Oren shows him that a rule making refusal free also makes refusal lawful on the worst day in the worst weather. The work is done: apron, joint course, brace, count, salt crack. The district's new two-book ledger puts paid work in one book and refusals in the other, and Vale enters the household's refusal under a position heading until Tarin points at the fourth column. Sera returns with the print shop's answer: the authorization for run 114 was cut out of the stock ledger and replaced by one signed by a preservation authority rather than a person. The form's print strip shows the run was distributed to a plate office six days before the ninth-bridge public notice.
